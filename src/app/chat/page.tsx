...
const ChatPage: FC = () => {
  ...
  return (
    <div>
      <div className="fixed w-1/2 left-1/2 -translate-x-1/2 max-h-[80vh] overflow-auto p-2" ref={divRef}>
      ...
      <div className="fixed bottom-0 left-1/2 -translate-x-1/2 w-1/2 p-2">
